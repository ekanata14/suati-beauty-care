...
<section class="h-screen flex flex-col md:flex-row items-center justify-center bg-gradient-to-br from-white via-blue-100 to-blue-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 py-16 px-4">
    <div class="w-full md:w-1/2 flex justify-center" data-aos="fade-right">
        <img src="{{ asset($content['logo']) }}" alt="logo" class="w-3/4 max-w-xs md:max-w-md rounded-xl shadow-xl">
    </div>
    <div class="max-w-xl w-full md:w-1/2 mt-10 md:mt-0 px-4" data-aos="fade-left">
        <h1 class="text-4xl font-extrabold text-gray-900 dark:text-white mb-6 leading-snug">{{ $content['title'] }}</h1>
...
<section id="location" class="py-20 bg-blue-50 dark:bg-gray-900" data-aos="fade-up">
    <div class="container mx-auto px-6 md:px-12">
        ...
        <div class="w-full h-[450px] overflow-hidden rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700" data-aos="zoom-in">
            <iframe
