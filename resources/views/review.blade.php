...
@section('content')
    <section class="py-8 antialiased dark:bg-gray-900 md:py-16 h-screen">
        <form method="POST" action="{{ route('review.store') }}" class="mx-auto px-4 2xl:px-0 flex gap-4 justify-center">
            ...
            <div class="space-y-6 bg-white p-6 w-full md:w-3/4 rounded-lg shadow" x-data="{ selectedRating: 0 }">
                <h4 class="text-xl font-semibold text-gray-900 dark:text-white">Submit Your Review</h4>
