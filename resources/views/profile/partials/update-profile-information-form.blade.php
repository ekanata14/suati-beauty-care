<section>
    ...
    @if ($user->role == 'admin')
        <form method="post" action="{{ route('admin.update.profile') }}" class="mt-6 space-y-6"
        ...
        <form method="post" action="{{ route('user.update.profile') }}" class="mt-6 space-y-6"
            ...
            <div>
                ...
                @if ($user->Konsumen->foto_profil)
                    <div class="mt-2">
                        <img src="{{ asset('storage/' . $user->Konsumen->foto_profil) }}"
                            alt="{{ __('Profile Photo') }}" class="w-40 h-40 rounded-full object-cover">
                    </div>
                @else
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="telepon" name="telepon" type="text" class="mt-1 block w-full"
                        :value="old('telepon', $user->Konsumen->telepon)" required />
