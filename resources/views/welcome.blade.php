...
@section('content')
    @foreach($homeContents as $content)
        <section class="h-[70vh] flex flex-col md:flex-row justify-center items-center bg-white">
                    ...
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <p class="mb-3 font-bold text-gray-900 dark:text-white">
                                IDR. {{ number_format($product->harga, 0, ',', '.') }} | <span class="text-green-700">
                                    {{ $product->stok }} in stock</span>
                            </p>
                            <a href="{{ route('products.detail', $product->id) }}"
